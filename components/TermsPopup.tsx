...
const TermsPopup: React.FC = () => {
	...
	return (
			<div className={styles.footer} style={{ position: 'fixed', top: 0, left: 0, width: '100%', height: '100%', backgroundColor: 'rgba(0,0,0,0.5)' }}>
				<div style={{ position: 'relative', width: '80%', margin: '10% auto', padding: '20px', background: '#fff' }}>
